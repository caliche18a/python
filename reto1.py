...
def CDT(usuario: str, capital: int, tiempo: int):
    ...
    return 'Para el usuario ' + str(usuario) + ' La cantidad de dinero a recibir, según el monto inicial ' + str(
        capital) + ' para un tiempo de ' + str(tiempo) + ' meses es: ' + str(Valor_total)